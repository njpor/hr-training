! function (e, t) {
	...
	const z = {
		...
		Pe = (e, t) => {
			var n, o, i, a, r, s = I(),
				c = D();
			(t.showConfirmButton || t.showDenyButton || t.showCancelButton ? te : ne)(s), Y(s, t, "actions"), n = s, o = c, i = t, a = j(), r = M(), s = H(), Be(a, "confirm", i), Be(r, "deny", i), Be(s, "cancel", i),
				function (e, t, n, o) {
	...
	const ln = (r, s, c) => new Promise((e, t) => {
			...
			Xt.swalPromiseResolve.set(r, e), Xt.swalPromiseReject.set(r, t), s.confirmButton.onclick = () => (e => {
				...
				capture: e.keydownListenerCapture
			}), e.keydownHandlerAdded = !0), t = r, "select" === (e = c).input || "radio" === e.input ? Ct(t, e) : ["text", "email", "number", "tel", "textarea"].includes(e.input) && (l(e.inputValue) || d(e.inputValue)) && (wt(j()), kt(t, e)), (e => {
				const t = k(),
					n = B();
