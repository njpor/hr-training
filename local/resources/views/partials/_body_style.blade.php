<head>
    ...
    <!--รูป tab-->
    <link rel="icon" href="{{ asset('files/assets/images/jas.png')}}" type="image/x-icon">
    ...
    <!-- Treeview css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('files/bower_components/jstree/css/style.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('files/assets/pages/treeview/treeview.css')}}">
