    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="{{ asset('/dashboard') }}">
                <img class="img-fluid" height="80" width="180" src="{{ asset('files/assets/images/logo6.png') }}"
                    alt="Theme-Logo" />
            </a>
        ...
        <div class="navbar-container container-fluid">
            ...
            <ul class="nav-right">
                ...
                <li class="user-profile header-notification">
                    <a href="#">
                        <img src="{{ asset('files/assets/images/por/yo.gif') }}" class="img-radius"
                            alt="User-Profile-Image">
                        <span>{{ Session::get('idpuser')->EmployeeID }} | {{ Session::get('idpuser')->TFName }}
                            {{ Session::get('idpuser')->TLName }}</span>
                        <i class="ti-angle-down"></i>
                    </a>
                    <ul class="show-notification profile-notification">
                        <li>
                            <a href="{{ url('#') }}" data-toggle="modal" data-target="#reset-password">
                                <i class="icofont icofont-edit"></i> เปลี่ยนรหัสผ่าน
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('logoutCookie') }}">
...
<div id="reset-password" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="login-card card-block login-card-modal">
            <form action="{{ url('resetPassword') }}" method="post" class="md-float-material was-validated">
                @csrf
                <div class="auth-box">
                    <div class="row m-b-0">
                        <div class="col-md-12" style="text-align: center">
                            <img class="img-fluid" width="150" src="{{ asset('files/assets/images/por/desk.gif') }}"
                                alt="Theme-Logo" />
                    ...
                    <input type="hidden" class="form-control" name="empid"
                        value="{{ Session::get('idpuser')->EmployeeID }}">
